...
const inputCls = "w-full rounded-xl border border-[var(--bg-grey)] px-4 py-3 outline-none focus:border-[var(--bg-green)] bg-white";
              ...
              <FieldArray name="fixedPackages">
                {({ push, remove }) => (
                  <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="md:col-span-2">
                            ...
                            <Field
                              ...
                              className={inputCls}
                            />
                            <ErrorMessage name={`fixedPackages.${index}.slotName`} component="p" className={err} />
                          </div>
                          ...
                          <div>
                            ...
                            <Field
                              ...
                              className={inputCls}
                            />
                            <ErrorMessage name={`fixedPackages.${index}.startTime`} component="p" className={err} />
                          </div>
                          ...
                          <div>
                            ...
                            <Field
                              ...
                              className={inputCls}
                            />
                            <ErrorMessage name={`fixedPackages.${index}.endTime`} component="p" className={err} />
                          </div>
                          ...
                          <div className="md:col-span-2">
                            ...
                            <Field
                              ...
                              className={inputCls}
                            />
                            <ErrorMessage name={`fixedPackages.${index}.price`} component="p" className={err} />
                          </div>
                        </div>
                    ...
                    <button
                      type="button"
                      onClick={() => push({ slotName: "", startTime: "", endTime: "", price: "" })}
            ...
            <div className="space-y-8">
                ...
                <div>
                  ...
                  {openTime && closeTime && (
                    <p className="text-[var(--text-secondary)] text-sm mb-4">
                      Times must be within working hours: <strong>{openTime} – {closeTime}</strong>
                    </p>
                  )}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                              <div>
                                ...
                                <Field
                                  ...
                                  className={inputCls}
                                />
                                <ErrorMessage name={`pricingRules.${index}.fromTime`} component="p" className={err} />
                              </div>
                              <div>
                                ...
                                <Field
                                  ...
                                  className={inputCls}
                                />
                                <ErrorMessage name={`pricingRules.${index}.toTime`} component="p" className={err} />
                              </div>
                              <div>
                                <label className="block mb-2 font-bold">Price (₹)</label>
                                <Field
                                  ...
                                  className={inputCls}
                                />
                                <ErrorMessage name={`pricingRules.${index}.price`} component="p" className={err} />
                              </div>
                            </div>
                            {index > 0 && (
                              <button
              ...
              <div>
                ...
                <p className="text-[var(--text-secondary)] mb-4">
                  ...
                  {openTime && closeTime && (
                    <> Times must be within <strong>{openTime} – {closeTime}</strong>.</>
                  )}
                </p>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              ...
                              <Field
                                ...
                                className={inputCls}
                              />
                              <ErrorMessage name={`blockedTimes.${index}.fromTime`} component="p" className={err} />
                            </div>
                            <div>
                              <label className="block mb-2 font-bold">To Time</label>
                              <Field
                                ...
                                className={inputCls}
                              />
                              <ErrorMessage name={`blockedTimes.${index}.toTime`} component="p" className={err} />
                            </div>
                          </div>
                          {index > 0 && (
                            <button
