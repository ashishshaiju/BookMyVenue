...
export const basicInfoSchema = Yup.object({
  VenueName: Yup.string().trim().required("Venue name is required").min(3, "Minimum 3 characters").max(100, "Maximum 100 characters"),

  VenueDescription: Yup.string().trim().required("Description is required").min(10, "Minimum 10 characters"),
