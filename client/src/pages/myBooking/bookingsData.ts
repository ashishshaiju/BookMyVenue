export const bookings = [
  {
    ...
    amenities: ['Parking', 'AC', 'Dining Area', 'Wifi', 'Generator', 'Stage'],

    cancellationPolicy: 'Free cancellation up to 7 days before event date.',
  },

  {
    ...
    amenities: ['Parking', 'Wifi', 'Rooms', 'Decoration Space'],

    cancellationPolicy: 'Cannot cancel after booking start time.',
  },

  {
    ...
    amenities: ['Parking', 'Sound System', 'Wifi', 'Dining Area'],

    cancellationPolicy: 'Past bookings cannot be cancelled.',
  },

  {
    ...
    amenities: ['Parking', 'AC', 'Rooms', 'Lift', 'Wifi'],

    cancellationPolicy: '50% refund if cancelled before 5 days.',
  },
];
