...
const ExplorePage = () => {
  ...
  const districtCities = {
    ...
    Pathanamthitta: ['Adoor', 'Pandalam'],
    Alappuzha: ['Cherthala', 'Haripad'],
        ...
        <aside className="sticky top-24">
          <div className=" max-h-[calc(100vh-7rem)] overflow-y-auto rounded-3xl border border-[var(--bg-grey)] bg-[var(--bg-tertiary)] p-6 ">
            ...
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" className="text-[var(--bg-green)] cursor-pointer">
                {' '}
                Clear{' '}
              </Button>
            </div>
            ...
            <div>
              ...
              <Slider defaultValue={[25000]} max={50000} step={1000} className="cursor-pointer" />
            ...
            <div>
              ...
              <Select disabled={!selectedDistrict}>
                <SelectTrigger className="w-full rounded-2xl h-12">
                  <SelectValue
                    placeholder={selectedDistrict ? 'Select a City' : 'select a district frst'}
                  />
                  <SelectContent>
                    {cities.map((city) => (
          ...
          <div className="mb-8 mt-20">
            <div className=" sticky  top-16  z-20 bg-[var(--bg-primary)] pt-4 pb-5 ">
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <Button className=" rounded-2xl h-14 px-8 bg-[var(--bg-green)] hover:opacity-90 ">
                  {' '}
                  Search{' '}
                </Button>
              </div>
