  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-10 ">
      ...
      <div className="flex flex-col justify-center items-center">
        <h2 className="text-3xl text-[var(--text-primary)] mt-10 font-semibold" >Create An Account</h2>
        ...
        >
          <Form className="flex flex-col gap-5 w-full mt-10">
            ...
            <button
              type="submit"
              className="bg-[var(--bg-secondary)] border-2 border-transparent hover:bg-[var(--bg-primary)] hover:border-2 hover:text-[var(--text-primary)] hover:border-[var(--bg-secondary)] transition-all duration-200 p-3 rounded-xl text-white font-medium"
            >
              Sign Up
            </button>
          </Form>
        ...
        <div className="mt-10">
            <p className="text-[var(--text-secondary)]">Already have an account?<Link to="/login" className="text-[var(--text-primary)] font-medium hover:underline transition-all " > Log in</Link></p>
        </div>
      </div>
    </div>
  );
