...
describe('toast utils', () => {
  ...
  describe('showSuccess', () => {
    it('should call toast.success with message and options', async () => {
      ...
      expect(mockSuccess).toHaveBeenCalledWith('Operation successful', expect.objectContaining({ duration: 3000 }))
    })
  })
  ...
  describe('showError', () => {
    it('should call toast.error with message and options', async () => {
      ...
      expect(mockError).toHaveBeenCalledWith('Something went wrong', expect.objectContaining({ duration: 4000 }))
    })
  })
  ...
  describe('showInfo', () => {
    it('should call toast with message and options', async () => {
      ...
      expect(mockToast).toHaveBeenCalledWith('Information', expect.objectContaining({ duration: 3000 }))
    })
  })
